...
export default function Header(
  ...
  const { user, setUser, fetchSessions, fetchSignInDetail, signInDetail } =
  ...
  return (
    <>
      <header className="f fx fcc relative z-20 w-10/12 py-4 text-white backdrop-blur-md sm:hidden">
        <Logo />
